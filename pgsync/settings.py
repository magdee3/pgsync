...
SKIP_ONLY_CHANGES = env.list("SKIP_ONLY_CHANGES", default=[])
...
REPLICATION_SLOT_CREATE_CHECK = env.bool("REPLICATION_SLOT_CREATE_CHECK", default=False)
...
ENABLE_DOC_SIZE = env.bool("ENABLE_DOC_SIZE", default=True)

ELASTICSEARCH_SCAN_MAX_RETRIES = env.int("ELASTICSEARCH_SCAN_MAX_RETRIES", default=6)
ELASTICSEARCH_SCAN_RETRY_DELAY_SECONDS = env.int("ELASTICSEARCH_SCAN_RETRY_DELAY_SECONDS", default=10)
